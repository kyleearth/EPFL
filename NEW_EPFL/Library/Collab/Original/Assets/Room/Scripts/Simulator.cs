...
public class Simulator : MonoBehaviour
{
    ...
    public SteamVR_Action_Boolean breathOnOff;
    ...
    void Start()
    {
        breathOnOff.AddOnStateDownListener(TriggerDown, handType);
        //breathOnOff.AddOnStateUpListener(TriggerUp, handType);
        //Debug.Log("Here");
        if (turnSimulatorOn)
        {
            sendBreathFlag = 0;
    ...
    void Update()
    {
        if (turnSimulatorOn && Input.GetKey("b"))
        {
            // Debug.Log("b key pressed");
            lock (flagLock)
            {
