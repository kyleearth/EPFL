...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_breatheSimulate p_breatheSimulate;
        ...
        public static SteamVR_Input_ActionSet_breatheSimulate breatheSimulate
        {
            get
            {
                return SteamVR_Actions.p_breatheSimulate.GetCopy<SteamVR_Input_ActionSet_breatheSimulate>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_breatheSimulate = ((SteamVR_Input_ActionSet_breatheSimulate)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_breatheSimulate>("/actions/breatheSimulate")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.breatheSimulate};
        }
    }
}
